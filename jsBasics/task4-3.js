...
// updated due to  comment 'I would not create dedicated variable for this but if
// you want you can name it like radiusPoweredTo2'

// const radiusPoweredTo2 = Math.pow(radius, 2)
// const cylinderVolume = pi*radiusPoweredTo2*height

const cylinderVolume = pi * (radius ** 2) * height; // updated due to comment
